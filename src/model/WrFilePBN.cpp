...
BOOL Deal::WriteFilePBN(CArchive& ar) {
  ...
  WriteComment(app_->FormString("File generated by Easy Bridge version %s", theApp.GetProgramVersionString()));
  WriteComment("");
  ...
  // Event tag
  WriteLine(TAG_EVENT, app_->FormString("%s Game", theApp.GetValue(tstrProgramTitle)), app_);
  ...
  */
  ...
  // Generator Tag
  WriteLine(TAG_GENERATOR, app_->FormString("Easy Bridge version %s", theApp.GetProgramVersionString()), app_);
