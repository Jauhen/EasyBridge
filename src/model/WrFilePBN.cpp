...
std::string Deal::WriteFilePBN() {
  ...
  fe.WriteComment((const char*)FormString("File generated by Easy Bridge version %s", app_->GetSettings()->GetProgramVersionString()));
  fe.WriteComment("");
  ...
  // Event tag
  fe.WriteLine(TAG_EVENT, (const char*)FormString("%s Game", app_->GetSettings()->GetProgramTitle()));
  ...
  */
  ...
  // Generator Tag
  fe.WriteLine(TAG_GENERATOR, (const char*)FormString("Easy Bridge version %s", app_->GetSettings()->GetProgramVersionString()));
