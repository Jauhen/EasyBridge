...
//
CCard* CCombinedHoldings::GetCard(int nSuit, int nPos) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetAt(nPos); }

CCard* CCombinedHoldings::GetCard(int nCardValue) const { return GetCard(CARDSUIT(nCardValue), FACEVAL(nCardValue)); }

CCombinedSuitHoldings& CCombinedHoldings::GetSuit(int nSuit) { VERIFY((nSuit >= 0) && (nSuit <= 3)); return *(m_pSuit[nSuit]); }

int CCombinedHoldings::GetNumCardsInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumCards(); }
...
int CCombinedHoldings::GetNumPlayersCardsInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetDeclarerLength(); }

int CCombinedHoldings::GetNumPartnersCardsInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetDummyLength(); }

//
int	CCombinedHoldings::GetNumWinnersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumWinners(); }

int	CCombinedHoldings::GetNumLosersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumLosers(); }

int	CCombinedHoldings::GetNumLikelyWinnersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumLikelyWinners(); }

int	CCombinedHoldings::GetNumLikelyLosersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumLikelyLosers(); }

int	CCombinedHoldings::GetNumDeclarerWinnersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumDeclarerWinners(); }

int	CCombinedHoldings::GetNumDeclarerLosersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumDeclarerLosers(); }

int	CCombinedHoldings::GetNumDummyWinnersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumDummyWinners(); }

int	CCombinedHoldings::GetNumDummyLosersInSuit(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumDummyLosers(); }

//
int	CCombinedHoldings::GetSuitStrength(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetStrength(); }

int	CCombinedHoldings::GetSuitLength(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetNumCards(); }

double CCombinedHoldings::GetSuitHCPoints(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetHCPoints(); }

double CCombinedHoldings::GetSuitTotalPoints(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->GetTotalPoints(); }

int	CCombinedHoldings::GetNumSuitsOfAtLeast(int nLength) const { return m_numSuitsOfAtLeast[nLength]; }

//
BOOL CCombinedHoldings::SuitHasCard(int nSuit, int nCardFaceValue) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->HasCardOfFaceValue(nCardFaceValue); }

BOOL CCombinedHoldings::SuitHasAce(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->HasAce(); }

BOOL CCombinedHoldings::SuitHasKing(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->HasKing(); }

BOOL CCombinedHoldings::SuitHasQueen(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->HasQueen(); }

BOOL CCombinedHoldings::SuitHasJack(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->HasJack(); }

BOOL CCombinedHoldings::SuitHasTen(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->HasTen(); }

BOOL CCombinedHoldings::IsSuitStopped(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->IsSuitStopped(); }

BOOL CCombinedHoldings::IsSuitProbablyStopped(int nSuit) const { VERIFY((nSuit >= 0) && (nSuit <= 3)); return m_pSuit[nSuit]->IsSuitProbablyStopped(); }
