...
public:
	...
	// to return the control bar from Maximize to average size

	void Average(CCJControlBar *);
	...
	void CalcSizeBarLayout(CCJControlBar* pBarDock, BOOL bFlag);
...
// Overrides
	...
	virtual void DockControlBar(CControlBar* pBar, LPCRECT lpRect = NULL);
	virtual int Insert(CCJControlBar* pBarIns, CRect rect, CPoint ptMid);
	//}}AFX_VIRTUAL
